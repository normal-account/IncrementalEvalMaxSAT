...
CardIncremental_Lazy::CardIncremental_Lazy( CardIncremental_Lazy &other ) :
    VirtualCard( other.solver, other._maxVars, other.bound)
{
    auto newTree = *other._tree;
    _tree = std::make_shared<TotTree>(newTree);

    _maxVars = other._maxVars;
}
